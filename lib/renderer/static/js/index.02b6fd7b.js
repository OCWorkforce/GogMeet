(()=>{"use strict";let e={type:"loading"},t="",a=null,n=null;function s(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function r(){var a;let r,i,o,l=document.getElementById("app");if(!l)return;l.innerHTML=`<div class="body">${function(e){switch(e.type){case"loading":return`
